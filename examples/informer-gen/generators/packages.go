...
func Packages(context *generator.Context, arguments *args.GeneratorArgs) generator.Packages {
	...
	internalVersionPackagePath := filepath.Join(arguments.OutputPackagePath, "pkg/client/informers/informers_generated/internalversion")
	externalVersionPackagePath := filepath.Join(arguments.OutputPackagePath, "pkg/informers")
