...
import (
	...
	"k8s.io/gengo/examples/client-gen/generators/fake"
	"k8s.io/gengo/examples/client-gen/generators/scheme"
		...
		GeneratorFunc: func(c *generator.Context) (generators []generator.Generator) {
			generators = []generator.Generator{
				...
				&genClientset{
					...
					outPutPath:    customArgs.ClientsetOutputPath,
...
func Packages(context *generator.Context, arguments *args.GeneratorArgs) generator.Packages {
	...
	clientsetPackage := filepath.Join(customArgs.ClientsetOutputPath, "client/clientset_generated/clientset")
