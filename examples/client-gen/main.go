...
import (
	...
	"k8s.io/gengo/args"
	clientgenargs "k8s.io/gengo/examples/client-gen/args"
	"k8s.io/gengo/examples/client-gen/generators"
	"k8s.io/gengo/examples/client-gen/types"
...
var (
	...
	basePath               = flag.String("input-base", "github.com/liubog2008/test/tenant/pkg/apis", "base path to look for the api group.")
	...
	clientsetPath          = flag.String("clientset-path", "github.com/liubog2008/test/tenant/pkg", "the generated clientset will be output to <clientset-path>/<clientset-name>.")
...
func main() {
	...
	if *test {
		arguments.InputDirs = append(dependencies, []string{
			"k8s.io/gengo/examples/client-gen/test_apis/testgroup",
		}...)
		arguments.CustomArgs = clientgenargs.Args{
			...
			GroupVersionToInputPath: map[types.GroupVersion]string{
				{Group: "testgroup", Version: ""}: "k8s.io/gengo/examples/client-gen/test_apis/testgroup",
			},
			ClientsetName:       "test_internalclientset",
			ClientsetOutputPath: "k8s.io/gengo/examples/client-gen/testoutput/clientset_generated/",
			ClientsetOnly:       false,
			FakeClient:          true,
			CmdArgs:             cmdArgs,
		}
