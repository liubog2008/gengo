...
import (
	...
	testgroup "k8s.io/gengo/examples/client-gen/test_apis/testgroup"
	scheme "k8s.io/gengo/examples/client-gen/testoutput/clientset_generated/test_internalclientset/scheme"
)
